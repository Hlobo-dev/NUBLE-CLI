"""
KYPERIAN ELITE - Redis Cache Layer
====================================
...
class RedisCache:
    """
    High-performance Redis cache for KYPERIAN signals.
    ...
    def __init__(self, config: Optional[CacheConfig] = None):
        ...
        # Key prefixes
        self.PREFIX_SIGNAL = "kyperian:signal"
        self.PREFIX_DECISION = "kyperian:decision"
        self.PREFIX_ALIGNMENT = "kyperian:alignment"
        self.PREFIX_VETO = "kyperian:veto"
