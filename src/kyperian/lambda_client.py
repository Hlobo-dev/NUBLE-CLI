"""
KYPERIAN Lambda Decision Engine Client
=======================================

Institutional-Grade Market Intelligence API

This module provides direct access to the KYPERIAN production decision engine,
...
USAGE:
    from kyperian.lambda_client import analyze_symbol, get_lambda_client
...
KYPERIAN_API_BASE = "https://9vyvetp9c7.execute-api.us-east-1.amazonaws.com/production"
...
class LambdaAnalysis:
    ...
    This is the primary data structure returned by the KYPERIAN API,
...
class KyperianLambdaClient:
    """
    Institutional-Grade Market Intelligence API Client
    
    Production-ready client for the KYPERIAN Lambda Decision Engine.
    ...
    def __init__(
        ...
        self.base_url = base_url or KYPERIAN_API_BASE
    ...
    def session(self) -> requests.Session:
        ...
        if self._session is None:
            ...
            self._session.headers.update({
                ...
                'User-Agent': 'KYPERIAN-CLI/6.0.0-APEX',
...
# Singleton instance
_lambda_client: Optional[KyperianLambdaClient] = None


def get_lambda_client() -> KyperianLambdaClient:
    """Get singleton Lambda client instance."""
    global _lambda_client
    if _lambda_client is None:
        _lambda_client = KyperianLambdaClient()
...
def format_analysis_for_context(analysis: LambdaAnalysis) -> str:
    ...
    parts.append(f"## KYPERIAN Decision Engine: {analysis.symbol}")
