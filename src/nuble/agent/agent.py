...
class Agent:
    ...
    def _get_market_data(self, question, title, description):
        ...
        Fallback when Lambda is unavailable.
        """
        from ..manager import CRYPTO_TICKERS as _CRYPTO_MAP
        ...
        for ticker in tickers[:3]:
            try:
                ...
                api_ticker = _CRYPTO_MAP.get(ticker, ticker)
