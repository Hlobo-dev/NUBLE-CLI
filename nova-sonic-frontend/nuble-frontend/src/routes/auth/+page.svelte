					...
					<div class=" my-auto pb-10 w-full sm:max-w-md">
						...
						>
							<div class="flex items-center gap-2">
								{$i18n.t('Signing in to')}
								<img
									src="/roket-logo-black.png"
									class="h-7 w-auto inline-block dark:hidden"
									alt="ROKET"
									draggable="false"
								/>
								<img
									src="/roket-logo-white.png"
									class="h-7 w-auto hidden dark:inline-block"
									alt="ROKET"
									draggable="false"
								/>
							</div>
				...
				{:else}
					<div class="my-auto flex flex-col justify-center items-center">
						<div class=" sm:max-w-md my-auto pb-10 w-full dark:text-gray-100">
							{#if $config?.metadata?.auth_logo_position === 'center'}
								<div class="flex justify-center mb-6">
									<img
										...
										class="size-24 rounded-full block dark:hidden"
										alt=""
									/>
									<img
										id="logo-dark"
							...
							>
								<div class="mb-1">
									<div class=" text-2xl font-medium flex items-center gap-2 flex-wrap">
